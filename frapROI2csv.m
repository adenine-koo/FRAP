...
% generate ROI3 (of the same size as ROI2).
...
% 1. One csv file is generated for each input nd2 file and stored in the 
% data folder path (first line of infile.txt) 
% Output filename format: todaydate-nd2filename.csv
% 2. Specified by savemovie TF: one avi movie of the cropped ROI2/doughnut
% for each nd2 file
% Output filename format: todaydate-nd2filename.avi
